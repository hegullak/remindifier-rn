...
export const no = {
  ...
  myself: {
    ...
    showQr: "Vis QR",
    hideQr: "Skjul QR",
    qrHint: "Del denne koden så andre kan legge deg til i echoflow",
  ...
  settings: {
    ...
    signInClerkLeadAfter:
      "). De administrerer e-post, passord og sesjon — echoflow ser aldri passordet ditt.",
    ...
    changePasswordHint: "Passord endres hos Clerk, ikke i echoflow.",
    currentPassword: "Nåværende passord",
    newPassword: "Nytt passord",
    confirmPassword: "Bekreft nytt passord",
    calendar: {
      title: "Kalendere i Brief",
      readOnlyNote: "echoflow endrer aldri disse kalenderne — velg hvilke som vises i briefen.",
    ...
    echoCalendar: {
      title: "Din echoflow-kalender",
      note: "echoflow oppretter sin egen kalender på denne enheten. Kopier inn andre kalendere for å redigere fritt der — de opprinnelige kalenderne dine endres aldri.",
      permissionNeeded: "Kalendertilgang kreves for å sette opp echoflow-kalenderen.",
      grantAccess: "Gi kalendertilgang",
      empty: "Fant ingen andre kalendere på enheten.",
      copy: "Kopier inn",
      linked: "Kopiert inn",
      lastSynced: "Sist synkronisert {time}",
      neverSynced: "Ikke synkronisert ennå",
      syncAgain: "Synkroniser på nytt",
      remove: "Fjern",
  ...
  about: {
    ...
    disclaimer:
      "echoflow er et personlig hukommelsesverktøy. Appen gir ikke medisinske, juridiske eller psykologiske råd. All informasjon du legger inn brukes kun til å hjelpe deg med å huske.",
  },
  auth: {
  ...
  brief: {
    ...
    dateWeek: "Uke {week}",
    pastEvents: "{count} passerte hendelser",
  ...
  signInForm: {
    ...
    hintTotp:
      "Åpne Google Authenticator, 1Password eller lignende. Velg kontoen for echoflow og skriv inn den 6-sifrede koden som vises nå (den bytter hvert 30. sekund).",
  ...
  scan: {
    ...
    invalidQr: "Dette er ikke en gyldig echoflow QR-kode. Prøv igjen.",
