export const en = {
  ...
  profile: {
    menuTitle: "Profile",
    settings: "Settings",
    guitarTheme: "Guitar theme",
    guitarThemeHint: "Warm amber theme from echonote",
  },
  onboarding: {
  ...
  myself: {
    ...
    showQr: "Show QR",
    hideQr: "Hide QR",
    qrHint: "Share this code so others can add you in echoflow",
  ...
  settings: {
    ...
    signInClerkLeadAfter:
      "). They manage email, password, and your session — echoflow never sees your password.",
    noName: "No name set",
    editName: "Edit name",
    ...
    changePasswordHint: "Password is changed with Clerk, not in echoflow.",
  ...
  about: {
    ...
    disclaimer:
      "echoflow is a personal memory tool. The app does not provide medical, legal, or psychological advice. All information you enter is only used to help you remember.",
  },
  auth: {
  ...
  brief: {
    ...
    dateWeek: "Week {week}",
    pastEvents: "{count} passed events",
  ...
  signInForm: {
    ...
    hintTotp:
      "Open Google Authenticator, 1Password, or similar. Select the echoflow account and enter the 6-digit code shown now (it changes every 30 seconds).",
  ...
  scan: {
    ...
    invalidQr: "This is not a valid echoflow QR code. Try again.",
